...
SEO 关键词：Ansys MCP、AEDT MCP server、Ansys Electronics Desktop 自动化、PyAEDT MCP、HFSS 自动化、HFSS 远场自动化、Touchstone 导出、Maxwell 自动化、Q3D 自动化、Icepak 自动化、AI 仿真 Agent、电磁仿真自动化、EDA Agent 工具、CAE 自动化。
...
- **仿真流程工具：** 变量、数据集、几何、材料、setup 检查与更新、参数扫描、优化、分析、报告、场图、远场、天线/RCS 数据、Q3D 网络、Icepak 风扇数据、Touchstone 数据/导出、监控数据和导出。
